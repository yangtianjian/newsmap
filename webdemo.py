...
def home():
    db = mysql.connector.connect(user='root', passwd='', db='news', charset='utf8')
...
<br/>
<div id="main" style="width: 1000px;height:800px;margin:auto"></div>
...
def home2():
    keyword = request.form['keyword']
    db = mysql.connector.connect(user='root', passwd='?&*()NSDWE19', db='news', charset='utf8')
    cur = db.cursor()
    ids = query(keyword)
    idstr = ""
    for identification in ids:
