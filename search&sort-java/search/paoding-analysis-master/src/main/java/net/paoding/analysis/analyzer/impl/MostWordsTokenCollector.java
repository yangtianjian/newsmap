 ...
 * @since 1.1
 */
public class MostWordsTokenCollector implements TokenCollector, Iterator<PackedTokenAttributeImpl> {
    ...
    private static class LinkedToken extends PackedTokenAttributeImpl implements Comparable<LinkedToken> {
        /**
         *
         */
