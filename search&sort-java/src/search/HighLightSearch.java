...
class Search {  
    ...
    public void search(String keyWord) {  
        ...
        try {  
            // 1、创建Directory  
            Directory directory = FSDirectory.open(FileSystems.getDefault().getPath("F:\\search\\data"));
            // 2、创建IndexReader  
            ...
            TokenStream ts = analyzer.tokenStream("test", new StringReader(keyWord));
