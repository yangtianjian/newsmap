...
def get_a_province_news(conn, url, province):
...
def main():
    ...
    for province in entry_dict.keys():
        t = threading.Thread(target=get_a_province_news, args=(conn, entry_dict[province], province))
